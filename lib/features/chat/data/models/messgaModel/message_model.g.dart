...
MessageModel _messageModelDeserialize(
  ...
  final object = MessageModel(
    ...
    status:
        _MessageModelstatusValueEnumMap[reader.readByteOrNull(offsets[5])] ??
...
extension MessageModelQueryWhereSort
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhere> anyStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension MessageModelQueryWhere
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> statusEqualTo(
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> statusNotEqualTo(
      MessageStatus status) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> statusGreaterThan(
    MessageStatus status, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> statusLessThan(
    MessageStatus status, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> statusBetween(
    MessageStatus lowerStatus,
    MessageStatus upperStatus, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
